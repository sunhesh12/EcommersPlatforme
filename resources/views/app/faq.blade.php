...
<div class="faqContainer">
    ...
    <div>
        ...
        <ol type="a">
            ...
            <li>References to a party or a person include any form of entity and their respective successors, assigns, and representatives;</li>
            <li>For all periods and times specified in clauses 5 and 11, time is of the essence;</li>
